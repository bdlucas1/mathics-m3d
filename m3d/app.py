    ...
    def update(self, expr=None):
        try:
            ...
            if "method" in self.options:
                raise Exception("method option no longer supported")
...
class Top(m3d.ui.Stack):
    ...
    def __init__(
        ...
        # we support the output generated by vectorized plotting routines,
        # so load the vectorized plotting module
        if not classic:
            # TODO: error checking
